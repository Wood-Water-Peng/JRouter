...
class Logger {
    ...
    static void printCopyright() {
        println()
        println("${com.example.jrouter.LogUI.C_BLACK_GREEN.value}" + "####################################################################" + "${com.example.jrouter.LogUI.E_NORMAL.value}")
        println("${com.example.jrouter.LogUI.C_BLACK_GREEN.value}" + "###                                                              ###" + "${com.example.jrouter.LogUI.E_NORMAL.value}")
        println("${com.example.jrouter.LogUI.C_BLACK_GREEN.value}" + "###                                                              ###" + "${com.example.jrouter.LogUI.E_NORMAL.value}")
        println("${com.example.jrouter.LogUI.C_BLACK_GREEN.value}" + "###          欢迎使用 jrouterAnalytics® (v" + RouterTransform.VERSION + ")编译插件         ###" + "${com.example.jrouter.LogUI.E_NORMAL.value}")
        println("${com.example.jrouter.LogUI.C_BLACK_GREEN.value}" + "###               使用过程中碰到任何问题请自己解决,然后告诉我               ###" + "${com.example.jrouter.LogUI.E_NORMAL.value}")
        println("${com.example.jrouter.LogUI.C_BLACK_GREEN.value}" + "###                         GitHub 地址：                        ###" + "${com.example.jrouter.LogUI.E_NORMAL.value}")
        println("${com.example.jrouter.LogUI.C_BLACK_GREEN.value}" + "###     https://github.com/Wood-Water-Peng/jrouter           ###" + "${com.example.jrouter.LogUI.E_NORMAL.value}")
        println("${com.example.jrouter.LogUI.C_BLACK_GREEN.value}" + "###                                                              ###" + "${com.example.jrouter.LogUI.E_NORMAL.value}")
        println("${com.example.jrouter.LogUI.C_BLACK_GREEN.value}" + "###                                                              ###" + "${com.example.jrouter.LogUI.E_NORMAL.value}")
        println("${com.example.jrouter.LogUI.C_BLACK_GREEN.value}" + "####################################################################" + "${com.example.jrouter.LogUI.E_NORMAL.value}")
        println()
    ...
    def static error(Object msg) {
        try {
            println("${com.example.jrouter.LogUI.C_ERROR.value}[SensorsAnalytics]: ${msg}${com.example.jrouter.LogUI.E_NORMAL.value}")
        } catch (Exception e) {
            e.printStackTrace()
        }
    }
    ...
    def static warn(Object msg) {
        try {
            println("${com.example.jrouter.LogUI.C_WARN.value}[SensorsAnalytics]: ${msg}${com.example.jrouter.LogUI.E_NORMAL.value}")
        } catch (Exception e) {
            e.printStackTrace()
        }
    }
